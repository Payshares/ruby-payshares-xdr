...
[![Travis CI Build Status](https://travis-ci.org/payshares/ruby-payshares-xdr.svg)](https://travis-ci.org/payshares/ruby-payshares-xdr)
...
Code generated by `payshares-xdrgen`, which targets this library, uses autoload extensively.
...
ruby-xdr by itself does not have any ability to parse XDR IDL files and produce a parser for your custom data types.  Instead, that is the responsibility of [payshares-xdrgen](http://github.com/payshares/payshares-xdrgen).  xdrgen will take your .x files and produce a set of ruby files that target this library to allow for your own custom types.

See [ruby-payshares-base](http://github.com/payshares/ruby-payshares-base) for an example (check out the generated directory)

## Contributing

1. Sign the [Contributor License Agreement](http://goo.gl/forms/6r7I4S0K4z)
2. Fork it ( https://github.com/payshares/ruby-payshares-xdr/fork )
